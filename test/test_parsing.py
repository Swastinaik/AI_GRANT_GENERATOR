...
def generate_resume_docx(data, template='classic', output_path='resume.docx'):
...
EXAMPLE_DATA = {
    ...
    'summary': 'Versatile Full Stack Developer with 6+ years of experience building scalable web applications and developer tools. Expertise in React, Node.js, TypeScript, Python, PostgreSQL, and AWS. Proven ability to design APIs, implement responsive UIs, and enhance application performance and developer experience. Passionate about clean code, test automation, and continuous delivery.',
    'contact': ['aarav.mehra.dev@example.com', '+91 98765 43210', 'linkedin.com/in/aarav-mehra'],
    'skills': ['JavaScript (ES6+)', 'TypeScript', 'Python', 'SQL', 'HTML5', 'CSS3', 'React', 'Redux/RTK', 'Next.js', 'Tailwind CSS', 'Storybook', 'Node.js', 'Express', 'NestJS', 'FastAPI', 'REST', 'GraphQL', 'PostgreSQL', 'MongoDB', 'Redis', 'AWS (Lambda, EC2, RDS, S3)', 'Docker', 'GitHub Actions', 'Terraform', 'Jest', 'React Testing Library', 'Cypress', 'ESLint', 'Prettier'],
    'experience': [
        {
            'title': 'Senior Full Stack Developer',
            'company': 'Nimbus Labs',
            'duration': 'Jul 2021 – Present',
            'description': 'Led a team of 4 developers in building a multi-tenant SaaS analytics platform using React, TypeScript, and Node.js. Designed and implemented a GraphQL API, reducing data overfetching by 40%. Migrated legacy reporting pipelines to serverless architecture on AWS Lambda, cutting infrastructure costs by ~30%. Introduced component library and Storybook, improving UI consistency and reducing design implementation time by 25%.'
        },
        {
            'title': 'Full Stack Developer',
            'company': 'Orbital Technologies',
            'duration': 'May 2018 – Jun 2021',
            'description': 'Built single-page applications with React and Redux for internal CRM and customer portal. Implemented RESTful APIs and microservices using Express.js and PostgreSQL with indexing and query optimization. Added CI/CD pipelines using GitHub Actions, automating deployments per merge.'
        },
        {
            'title': 'Software Engineer (Backend Focus)',
            'company': 'PixelForge Solutions',
            'duration': 'Aug 2016 – Apr 2018',
            'description': 'Developed Python-based ETL services and APIs to support data ingestion and transformations for analytics. Collaborated with frontend teams to expose well-documented REST endpoints and mocked APIs during feature development.'
        }
    ],
    'education': [
        {'degree': 'Bachelor of Technology (B.Tech.) in Computer Science', 'institution': 'Visvesvaraya Technological University', 'year': '2016'}
    ],
    'projects': [
        {'name': 'Realtime Collaboration Editor', 'description': 'Built a collaborative rich-text editor using WebSockets and operational transforms. Implemented presence and live cursors; used Redis for session coordination and persisted documents to PostgreSQL.'},
        {'name': 'E-commerce Microservices Platform', 'description': 'Designed checkout and payments microservice with event-driven architecture using AWS SNS/SQS and idempotent processing. Improved throughput and failure recovery.'}
    ],
    'certifications': ['AWS Certified Developer – Associate (2022)', 'Professional Certificate in Full Stack Web Development — Coursera (2020)']
}

if __name__ == '__main__':
    print('Generating example resumes...')
    classic = generate_resume_docx(EXAMPLE_DATA, template='classic', output_path='resume_classic.docx')
    modern = generate_resume_docx(EXAMPLE_DATA, template='modern', output_path='resume_modern.docx')
    print('Done:')
    print(' -', classic)
    print(' -', modern)
"""